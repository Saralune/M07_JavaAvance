...
public class IBankBusinessImpl implements IBankBusiness {
	...
	public boolean isAccountExists(long accountId) {
		for (int i = 0; i < accounts.size(); i++) {
			if(accountId == listAccounts().get(i).getAccountId()) {
				return true;
			} 
		}
		throw new RuntimeException("Le compte n'existe pas.");
	...
	/**
	 * Affiche les choix à l'utilisateur
	 */
	public void displayMenu() {
		System.out.println("\n----- Taper le numéro correspondant -----");
		System.out.println("1. Versement - 2. Retrait - 3. Virement - 4. Informations sur ce compte - 5. Liste des opérations - 6. Sortir");
	}
